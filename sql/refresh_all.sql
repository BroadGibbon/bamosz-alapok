...
-- Sorrend: hozamok -> forgalom -> vol+drawdown -> Sharpe/Sortino -> likviditás -> gold -> piaci AUM
...
-- Napi teljes piaci AUM kategóriánként, forintra váltva — ELŐSZÁMÍTOTT TÁBLA (gyors olvasás).
...
from (
  select n.obs_date, d.category, n.nav,
